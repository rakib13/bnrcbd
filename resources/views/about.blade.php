                        ...
                        <div id="mission" class="about-item-content bg-white rounded p-5 h-100 section active">
                            ...
                            <div class="mission-content">
                                <div class="mission-text">
                                    <p>The BNRC is committed to conducting high-quality research and analysis on
                                        national
                                        and
                                        ...
                                        to
                                        empower
                                        leadership and inspire progress for the betterment of Bangladesh....... The BNRC is
                                        committed to conducting high-quality research and analysis on
                                        national
                                        and
                                        international issues, providing strategic insights to the Bangladesh Nationalist
                                        Party,
                            ...
                            <div class="vision-content">
                                <div class="vision-text">
                                    <p>To be the leading research institution in Bangladesh, driving evidence-based
                                        ...
                                        uphold
                                        democratic values....... To be the leading research institution in Bangladesh,
                                ...
                                <div class="vision-img">
                                    <img src="{{ asset('img/vision img.jpg') }}" alt="vision illustration"
                                        class="img-fluid rounded">
                                </div>
                            </div>
                        </div>
