        ...
        <div class="row g-5 align-items-start">
            ...
            <div class="col-12 d-flex p-2 position-relative">
                ...
                <div class="content-area wow fadeInUp" data-wow-delay="0.2s"
                    ...
                    <div id="vision" class="about-item-content bg-white rounded p-3 h-100 section active">
                        <h4 class="text-primary text-center">Vision</h4>

                        <div class="vision-img d-flex flex-column flex-md-row align-items-start mt-3">
