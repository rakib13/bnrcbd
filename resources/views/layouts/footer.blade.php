                    ...
                    <div class="mb-2">
                        <div class="row g-4">
                            <div class="col-md-6 col-lg-6 col-xl-4">
                                ...
                                <div id="nav-logo">
                                    <a href="{{ url('/') }}"
                                        class="navbar-brand d-flex align-items-center p-0 me-0">
                                        ...
                                        <div class="col-4">
                                            <div class="footer-instagram">
                                                ...
                                                <a href="https://roadtodemocracy.com/" target="_blank">
                                                    ...
                                                    <img src="{{ asset('./img/road-to-democracy.png') }}"
                                                        alt="Logo BNRC" class="img-fluid" alt="Logo BNRC"
                                                        class="img-fluid" width="96px">
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <div class="d-flex shrink-0">
                            <div class="footer-btn d-flex px-0">
                                <a class="btn btn-md-square rounded-circle me-3"
                                    href="https://www.facebook.com/bnrc.org" target="_blank"><i
