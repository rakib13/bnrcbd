        ...
        <div class="col-lg-11">
            <div class="card shadow border-0">
                <div class="card-body p-5">
                    ...
                    <form action="{{ url('/update-user/' . $userInfo->id) }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-12">
                                <a class="btn btn-primary px-3 py-2 me-3" href="{{ url('/user-list') }}">Back to User List
                                </a>
                            </div>
                            <!-- Full Name -->
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <select class="form-select" id="role" name="role" required>
                                        ...
                                        <option {{ $userInfo->role == 'admin' ? 'selected' : '' }} value="admin">Admin
                                        </option>
                                        <option {{ $userInfo->role == 'user' ? 'selected' : '' }} value="user">User
                                        </option>
                                    </select>
